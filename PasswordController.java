...
public class PasswordController implements Initializable {
    ...
    @FXML
    private ChoiceBox<String> numberOfSigns;

    @FXML
    private void generate() {
        String selectedItem = numberOfSigns.getSelectionModel().getSelectedItem();
        int lenghtOfPassword = Integer.valueOf(selectedItem);
